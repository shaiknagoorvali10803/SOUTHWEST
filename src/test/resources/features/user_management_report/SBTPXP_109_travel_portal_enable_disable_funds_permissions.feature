@Story_SBTPSF-164 @Feature_SBTP-24 @SBTPXP-109 @Dashboard_reports @SBTPSF_Sprint_6 @User_Management_Report
Feature: User Management Report
  ...
  Scenario Outline: TP - Verify the TMC Full Access User can enable and disable the permissions under "Benefits & Request Permissions" Section
    ...
    Examples:
      ...
      | Email                           | Permissions                       |
      | mark.varied_access_ctm@test.com | View Transferability Report       |
      | mark.varied_access_ctm@test.com | View Rapid Reward Business Points |
      | mark.varied_access_ctm@test.com | View Unused Tickets Report        |
      | mark.varied_access_ctm@test.com | View Unused Flight Credit Report  |