@Feature_SBTP-8 @Story_SBTPSF-183 @SBTPXP-256 @WaiversAndFavors @StatusMatchRequest
Feature: Benefits request Submission Status validation
  ...
  Scenario Outline: TP - Verify case layout for a newly created case.
    ...
    Examples:
      ...
      | avery.fulltmc@test.com | Send to the Traveler to complete |          |testln    |swa.teststatusmatchid@Test.com  |
      | avery.fulltmc@test.com | Send to the Traveler to complete | testfn   |          |swa.teststatusmatchid@Test.com  |
      | avery.fulltmc@test.com | Send to the Traveler to complete | testfn   |testln    |                                   |
      | avery.fulltmc@test.com | Send to the Traveler to complete |          |testln    |swa.teststatusmatchid@Test.com  |
      | avery.fulltmc@test.com | Send to the Traveler to complete | testfn   |          |swa.teststatusmatchid@Test.com  |
      | avery.fulltmc@test.com | Send to the Traveler to complete | testfn   |testln    |                                   |